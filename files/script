...
#20mb
sudo taskset "$CORE" $PARSEDIR/parsecmgmt -a run -p blackscholes -i simsmall >> $OUTDIR/blackscholes/raw/bs_"$S"_raw
grep -E '^(IPC*|Total*)' $OUTDIR/blackscholes/raw/bs_"$S" >> $OUTDIR/blackscholes/bs_"$S"
